...
| CIS-13.5 | Manage Access Control for Remote Assets | ⚠️ Parcial | aplicacao_lifecycle (strong): 🏛️ Aplicação de Arquitetura Segura no Ciclo de Vida > 📝 User Stories reutilizáveis > US-02 - Ficha de solução com controlos e rastreabilidade arquitetural | Acesso remoto é condicionado por desenho, sem checks de postura explicitados |
