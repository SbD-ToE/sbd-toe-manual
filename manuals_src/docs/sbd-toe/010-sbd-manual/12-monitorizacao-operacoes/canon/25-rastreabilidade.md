...
| NIST SP800-53 | SP800-53-SI-8 — SP800-53-SI-8 | ✅ Semântico | Proteção contra spam é tratada como capacidade operacional contínua no catálogo OPS | requirements_catalog (strong): Catálogo de Requisitos de Monitorização e Operações |
