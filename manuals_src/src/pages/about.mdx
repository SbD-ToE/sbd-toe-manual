...
- **[Theory of Everything](/sbd-toe/teory-of-everything/intro)** — A filosofia e fundamentos
- **[Cap. 00 — Fundamentos](/sbd-toe/sbd-manual/fundamentos/intro)** — Como usar este manual
- **[Manual Técnico (Cap. 01–14)](/sbd-toe/sbd-manual)** — Conteúdo prescritivo
- **[Cross-check Normativo](/sbd-toe/cross-check-normativo/intro)** — Alinhamento com regulações
...
- **Novo no SbD-ToE?** → Leia [Theory of Everything](/sbd-toe/teory-of-everything/intro)
- **Quer usar este manual?** → Leia [Cap. 00 — Como Usar](/sbd-toe/sbd-manual/fundamentos/como-usar)
- **Implementando segurança?** → Vá a [Manual Técnico](/sbd-toe/sbd-manual)
- **Verificando compliance?** → Consulte [Cross-check Normativo](/sbd-toe/cross-check-normativo/intro)
