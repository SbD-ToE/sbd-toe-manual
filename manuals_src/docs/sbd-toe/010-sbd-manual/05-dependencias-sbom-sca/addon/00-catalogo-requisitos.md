...
Dependências AI/ML não se reduzem a pacotes via package manager — incluem **artefactos opacos** com superfície de ataque distinta. Distinguimos três regimes de consumo de modelo que têm implicações de risco diferentes na cadeia:
