...
| ACO-SCBI — Supply Chain & Build Integrity | Scaffold secundário de requisitos e rastreabilidade para critérios de trust em componentes de terceiros e support architecture-adjacent de build integrity; não constitui âncora primária |
