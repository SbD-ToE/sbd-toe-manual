...
7. ⚡ **Camada agentic transversal** — [`ARC-015`](/sbd-toe/sbd-manual/arquitetura-segura/addon/catalogo-requisitos-arquitetura#arc-015) (agente como *principal*), `REQ-AGN-001..004` (mandate, *kill-switch*, *intent*), `OPS-012..014` (audit per *tool*, *budget*, *jailbreak detection*) e Policy 38 (*mandates lifecycle*) cobrem **simultaneamente** o Art. 14 + Art. 15 + Art. 26 do AI Act **e** o Anexo I (Parte I) do CRA (cybersec by design). Uma única arquitectura, duas presunções de conformidade.

## Checklist de Convergência (SIM = pronto)

- [ ] Evidência de cibersegurança mapeada simultaneamente ao Art. 15 (AI Act) e ao Anexo I, Parte I (CRA) — incluindo [`ARC-015`](/sbd-toe/sbd-manual/arquitetura-segura/addon/catalogo-requisitos-arquitetura#arc-015) e *eval suites* (Cap. 10 §C5).
